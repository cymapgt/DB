...
class DBTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testSetDbTypeException() {
        $this->setExpectedException('cymapgt\Exception\DBException');
    ...
    public function testValidateDbParameters() {
        $dbParams = array();
        $this->setExpectedException('cymapgt\Exception\DBException','One or more default parameters for DB connection not set');
        DB::validateDbParameters($dbParams);
        $dbParams = array (
             'driver'   => 'pdo_sqlite',
             'path'     => __DIR__ . 'files/db.test.sqlite'
        );
        $this->setExpectedException('cymapgt\Exception\DBException','DB Connection validation failed.');
    }
